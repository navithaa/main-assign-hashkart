...
public class ProductController {
    ...
    public List<Product> getProductsByCategoryWithMinimumRating(@PathVariable String category, @PathVariable int rating) {
        return productService.getProductsByCategoryWithMinimumRating(category, rating);
    }

    @GetMapping("/category/{category}/price/{price}")
    public List<Product> getProductsByCategoryWithMaximumPrice(@PathVariable String category, @PathVariable int price) {
        return productService.getProductsByCategoryWithMaximumPrice(category, price);
    }
    @GetMapping("/category/{category}/rating/{rating}/price/{price}/sortedByPrice")
    public List<Product> getProductsByCategoryWithMinimumRatingAndMaximumPriceSortedByPrice(
            @PathVariable String category, @PathVariable int rating, @PathVariable int price) {
